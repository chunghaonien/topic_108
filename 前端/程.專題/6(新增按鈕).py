...
class WebBrowserWindow(QMainWindow):
    ...
    def init_ui(self):
        ...
        # 創建執行腳本的按鈕
        self.run_js_script_button = QPushButton("執行腳本", self)
        self.run_js_script_button.clicked.connect(self.run_js_script)
        self.run_js_script_button.setFixedSize(80, 30)
        ...
        button_layout.addWidget(self.run_js_script_button)  # 新增的按鈕
    ...
    # 定義 run_js_script 方法，用於執行 JavaScript 腳本
    def run_js_script(self):
        # 在這裡執行你的JavaScript腳本，例如：執行run_js_script.js
        js_file_path = 'run_js_script.js'
        self.load_js_file(js_file_path)
