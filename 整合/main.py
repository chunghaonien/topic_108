...
class LoginDialog(QDialog):
    ...
    def initUI(self):
        ...
        # 連接 LoginSignal 信號到 showLoginSuccess 槽函數
        self.communicator.LoginSignal.connect(self.showLoginSuccess)
    ...
    def showLoginSuccess(self, account, password):
        # 創建成功登入的彈出視窗
        login_success_popup = login_yes_not(self, self.communicator, self.account_textbox, self.password_textbox)
